document.addEventListener('DOMContentLoaded', function() {
    ...
    function getStoredDatasets() {
        return [
            { id: 1, name: 'Customer Behavior Dataset', rows: 5000, columns: 12 },
            { id: 2, name: 'Sales Performance Data', rows: 8000, columns: 15 },
            { id: 3, name: 'Marketing Campaign Results', rows: 3500, columns: 10 }
        ];
    }
