    ...
    function getStoredDatasets() {
        return [
            { 
                ...
                rows: 5000, 
                columns: 12,
                columns_list: ['customer_id', 'age', 'income', 'score', 'region', 'segment']
            },
            { 
                id: 2, 
            ...
            { 
                ...
                rows: 8000, 
                columns: 15,
                columns_list: ['sale_id', 'amount', 'quantity', 'product', 'category', 'date']
            },
            { 
                id: 4, 
                ...
                rows: 8500, 
                columns: 16,
                columns_list: ['sale_id', 'amount', 'quantity', 'product', 'category', 'date', 'discount']
            }
        ];
    }
